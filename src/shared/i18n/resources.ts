export const resources = {
  tr: {
    ...
    home: {
      ...
      upcomingEmpty: "Yaklasan anlar icin alan hazir.",
      overdueTitle: "Gecikenler",
      overdueDescription: "Ilgi isteyen anlar nazikce burada toplanacak.",
      overdueEmpty: "Su anda geciken bir an yok.",
      recentTitle: "Son anlar",
      recentDescription: "Ekledigin son anlar burada yer alacak.",
      recentEmpty: "Son anlar eklendiginde burada gorunecek.",
      insightTitle: "Kisa icgoru",
      insightDescription: "Zamanla ilgili destekleyici ozetler burada gorunecek.",
      insightEmpty: "Icgoruler zamanla burada belirecek.",
      insightNoMoments: "Ilk an eklendiginde Momenta burada sakin bir ozet sunacak.",
      insightOverdue: "Ilgi isteyen anlar var; Momenta bunlari sakin sekilde onde tutar.",
      insightUpcoming: "Yaklasan anlar gorunur durumda; hazirlik icin alanin var.",
      insightQuiet: "Bugun sakin gorunuyor; onemli anlarin guvende.",
    ...
    momentPresentation: {
      "status.upcoming": "Yaklasiyor",
      "status.overdue": "Gecikti",
      "status.recent": "Yeni",
      "time.countdownDays": "Kalan gun",
      "time.overdueDays": "Gecen gun",
      "time.elapsedDays": "Gecen sure",
      "accessibility.upcomingItem": "Yaklasan an",
      "accessibility.overdueItem": "Geciken an",
      "accessibility.recentItem": "Son an"
    },
    categories: {
      "family.label": "Aile",
  ...
  en: {
    ...
    home: {
      ...
      upcomingEmpty: "The upcoming moments space is ready.",
      overdueTitle: "Overdue",
      overdueDescription: "Moments that need attention will gather here gently.",
      overdueEmpty: "Nothing is overdue right now.",
      recentTitle: "Recent Moments",
      recentDescription: "Your recently added moments will appear here.",
      recentEmpty: "Recently added moments will appear here.",
      insightTitle: "Insight",
      insightDescription: "Supportive time-aware summaries will appear here.",
      insightEmpty: "Insights will appear here over time.",
      insightNoMoments: "Once the first moment is added, Momenta will offer a calm summary here.",
      insightOverdue: "Some moments need attention; Momenta keeps them calmly visible.",
      insightUpcoming: "Upcoming moments are visible, with space to prepare.",
      insightQuiet: "Today looks quiet; the moments that matter are safe.",
    ...
    momentPresentation: {
      ...
      "time.countdownDays": "Days left",
      "time.overdueDays": "Days overdue",
      "time.elapsedDays": "Days elapsed",
      "accessibility.upcomingItem": "Upcoming moment",
      "accessibility.overdueItem": "Overdue moment",
      "accessibility.recentItem": "Recent moment"
    },
    categories: {
      "family.label": "Family",
